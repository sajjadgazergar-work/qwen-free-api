...
class GeminiClientPool(metaclass=Singleton):
    ...
    def __init__(self) -> None:
        ...
        self.reconfigure(g_config.gemini.clients)

    def reconfigure(self, settings) -> None:
        """Replace configured accounts; newly selected clients initialize lazily."""
        self._clients = []
        self._id_map = {}
    ...
    async def init(self) -> None:
        ...
        if not self._clients:
            logger.warning("No Gemini clients configured; waiting for dashboard onboarding.")
            return
